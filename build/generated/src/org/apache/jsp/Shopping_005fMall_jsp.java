...
public final class Shopping_005fMall_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for (Product p : list) {
      ...
      out.write("                <!-- javascript: get_product(");
      out.print( p.getId());
      out.write(" 是javascript裡面的get_product(參數)方法)-->\r\n");
      ...
      out.print( p.getName());
      out.write("\" src=\"");
      out.print( p.getUrl() == null ?"images/watch-Black.png":"images/"+p.getUrl() );
      out.write("\">\r\n");
      out.write("                </a>\r\n");
      out.write("            </div>\r\n");
