    ...
    <div id="article">
        ...
        <form method="POST" action="<%= request.getContextPath()%>/user/check_out.do">
            <table border="1" style="width:80%">
                <tr>
                    <th>No.</th><th>名稱</th><th>圖片</th><th>原價</th><th>折扣</th><th>售價</th><th>數量</th><th>刪除</th>  
                </tr>
                ...
                <tr>
                    ...
                    <td><input style="width:5ex" type="number" value="<%= cart.getQuentity(p)%>" name="quantity_<%= p.getId()%>" min=""></td>
                ...
                <tr>
                    <td style="text-align: right" colspan="4">
                        ...
                        <select name="paymentType" id="paymentType" required>
                            ...
                            <!--列舉付款方式--><!--排列ordinal()並把列舉字串列出來--> <!--任何的型別轉字串用String.valueOf-->
                ...
                <tr>
                    <td colspan="4"><input type="button" value="回賣場" name="submit" onclick="location.href = '<%= request.getContextPath()%>/Shopping_Mall.jsp'"></td>
